...
public interface NightmareBossConfig extends Config {
	...
	default boolean nightmarePrayers() {
		return false;
	}
	...
	default boolean nightmarePrayerOverlay() {
		return false;
	}
	...
	default boolean nightmareParasites() {
		return false;
	}
	...
	default boolean nightmareHands() {
		return false;
	}
	...
	default Color handsColorOutline() {
		return Color.CYAN;
	}
