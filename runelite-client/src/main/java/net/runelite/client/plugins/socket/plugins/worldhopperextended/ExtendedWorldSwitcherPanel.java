    ...
    private JPanel buildHeader() {
        ...
        this.pingHeader.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent mouseEvent) {
                if (SwingUtilities.isRightMouseButton(mouseEvent))
                    return;
                ExtendedWorldSwitcherPanel.this.ascendingOrder = (ExtendedWorldSwitcherPanel.this.orderIndex != WorldOrder.PING || !ExtendedWorldSwitcherPanel.this.ascendingOrder);
                ExtendedWorldSwitcherPanel.this.orderBy(WorldOrder.PING);
            }
        });
        Objects.requireNonNull(this.plugin);
        ...
        this.worldHeader.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent mouseEvent) {
                if (SwingUtilities.isRightMouseButton(mouseEvent))
                    return;
                ExtendedWorldSwitcherPanel.this.ascendingOrder = (ExtendedWorldSwitcherPanel.this.orderIndex != WorldOrder.WORLD || !ExtendedWorldSwitcherPanel.this.ascendingOrder);
                ExtendedWorldSwitcherPanel.this.orderBy(WorldOrder.WORLD);
            }
        });
        Objects.requireNonNull(this.plugin);
        ...
        this.playersHeader.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent mouseEvent) {
                if (SwingUtilities.isRightMouseButton(mouseEvent))
                    return;
                ExtendedWorldSwitcherPanel.this.ascendingOrder = (ExtendedWorldSwitcherPanel.this.orderIndex != WorldOrder.PLAYERS || !ExtendedWorldSwitcherPanel.this.ascendingOrder);
                ExtendedWorldSwitcherPanel.this.orderBy(WorldOrder.PLAYERS);
            }
        });
        Objects.requireNonNull(this.plugin);
        ...
        this.activityHeader.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent mouseEvent) {
                if (SwingUtilities.isRightMouseButton(mouseEvent))
                    return;
                ExtendedWorldSwitcherPanel.this.ascendingOrder = (ExtendedWorldSwitcherPanel.this.orderIndex != WorldOrder.ACTIVITY || !ExtendedWorldSwitcherPanel.this.ascendingOrder);
                ExtendedWorldSwitcherPanel.this.orderBy(WorldOrder.ACTIVITY);
            }
        });
