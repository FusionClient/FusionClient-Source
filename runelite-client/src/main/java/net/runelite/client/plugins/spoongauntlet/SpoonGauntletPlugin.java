...
@PluginDescriptor(
        name = "[F] Gauntlet",
        description = "All-in-one plugin for the Gauntlet. <br> Credit: SpoonLite",
        tags = {"Gauntlet"},
...
public class SpoonGauntletPlugin extends Plugin {
    ...
    public BossAttackPhase currentPhase;
