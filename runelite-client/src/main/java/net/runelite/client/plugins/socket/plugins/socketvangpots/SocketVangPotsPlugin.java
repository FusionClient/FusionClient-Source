...
import static net.runelite.client.plugins.socket.plugins.socketvangpots.CoxUtil.FARMING;
import static net.runelite.client.plugins.socket.plugins.socketvangpots.CoxUtil.VANGUARDS;
