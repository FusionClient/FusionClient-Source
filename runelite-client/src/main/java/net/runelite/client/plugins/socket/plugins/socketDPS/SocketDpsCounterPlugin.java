...
public class SocketDpsCounterPlugin extends Plugin {
    ...
    protected void startUp() {
        ...
        BOSSES.addAll(Arrays.asList(5886, 5887, 5888, 5889, 5890, 5891, 5908, 6503, 6609, 5862,
                ...
                8369, 8370, 8371, 8372, 8373, 8374, 8375, 10830, 10831, 10832, 10833, 10834, 10835, 10836, 10847, 10848, 10849, 10850, 10851, 10852, 10853, 11279, 11278,
                11204, 11280, 11282));
    }
    ...
    private <K, V extends Comparable<? super V>> Map<K, V> sortByValue(Map<K, V> map) {
        return (Map<K, V>)map.entrySet().stream().sorted(Map.Entry.comparingByValue(Comparator.reverseOrder())).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, e2) -> e1, LinkedHashMap::new));
    }
