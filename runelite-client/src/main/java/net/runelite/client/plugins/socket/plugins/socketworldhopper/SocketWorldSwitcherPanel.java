...
class SocketWorldSwitcherPanel extends PluginPanel {
    ...
    private JPanel buildHeader()
    {
        ...
        pingHeader = new SocketWorldTableHeader("Ping", orderIndex == WorldOrder.PING, ascendingOrder, plugin::refresh);
        ...
        worldHeader = new SocketWorldTableHeader("World", orderIndex == WorldOrder.WORLD, ascendingOrder, plugin::refresh);
        ...
        playersHeader = new SocketWorldTableHeader("#", orderIndex == WorldOrder.PLAYERS, ascendingOrder, plugin::refresh);
        ...
        activityHeader = new SocketWorldTableHeader("Activity", orderIndex == WorldOrder.ACTIVITY, ascendingOrder, plugin::refresh);
